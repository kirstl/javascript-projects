...
// If commandOverride is false, then the shuttle should only launch if the fuel 
// and engine check are OK. If commandOverride is true, then the shuttle will 
// launch regardless of the fuel and engine status.
let commandOverride = true; 

if (commandOverride === false && fuelLevel > 5000 && engineIndicatorLight != "red blinking") {
    console.log("Ready to Launch!!!")
} else if (commandOverride === true && fuelLevel <= 2500 || engineIndicatorLight === "red blinking"){
    console.log("Launch Anyway!!!!!")
};
